import { useState, useEffect } from 'react'; // React library and specific hooks
...
const Content = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-4 text-gray-700" style={{ fontFamily: 'Poppins, sans-serif' }}>Describe Your Image...</h1>
      <div className="flex flex-col items-center">
        <textarea
          className="w-full md:w-1/2 p-2 h-16 border-4 border-gray-400 rounded-xl mb-4 outline-none"
          rows={3}
